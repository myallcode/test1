...
#Test 1: Post Note draft
	def test01_publish_note_draft_TC_24300
		loginPost
		...
		else puts "PD02T01: FAILED! Unable to save draft."
		end
		
		post_draft
	end

#Test 2: Post Article draft
	def test02_publish_article_draft_TC_24300
		loginPost
...
#Test 3: Post Media draft
	def test03_publish_media_draft_TC_24300
		loginPost
...
#Test 4: Post Event draft
	def test_04_publish_event_draft_TC_24300
		loginPost
